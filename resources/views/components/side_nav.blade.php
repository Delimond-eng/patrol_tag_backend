<nav class="side-nav">
    <ul>
        <li>
            <a href="javascript:;.html" class="side-menu {{ Route::is("dashboard") ? 'side-menu--active' : '' }}">
        ...
        <li>
            <a href="javascript:;" class="side-menu {{ Route::is("profile") ? 'side-menu--active' : '' }}">
        ...
        <li>
            <a href="javascript:;" class="side-menu {{ Route::is('forms') ? 'side-menu--active' : '' }}">
            ...
            <ul class="">
                <li>
                    <a href="{{ route('forms') }}" class="side-menu">
                        <div class="side-menu__icon"> <i data-lucide="activity"></i> </div>
