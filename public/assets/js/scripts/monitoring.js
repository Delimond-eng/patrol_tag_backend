            ...
            this.intervalId = setInterval(() => {
                get("/patrols.pending")
                    .then((res) => {
                        ...
                        if (this.hasInitialized && newPatrols.length > this.previousPatrolCount) {
                        ...
                        if (this.selectedPatrol) {
                            const updatedPatrol = this.patrolPendings.find(patrol => patrol.id === this.selectedPatrol.id);
                    ...
                    .catch((err) => {
                        ...
                        this.error = "Erreur lors de la récupération des patrouilles en attente.";
                    });
